...
#'
#' The function is vectorized over `n`. For a single value, the primes
...
#'   to `n` in ascending order if `n` is a single number,
...
#' `.Machine$integer.max` the same three figures are 268 MB,
