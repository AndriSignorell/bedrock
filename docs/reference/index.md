...
- [`revX()`](revX.md) : Reverse the Order of Elements
...
- [`checkCount()`](checkCount.md) : Validate a Count

- [`checkString()`](checkString.md) : Validate a Character String
...
- [`roundTo()`](roundTo.md) : Round to a Multiple
- [`unirootAll()`](unirootAll.md) : Find multiple roots of a function
  within an interval
- [`nDec()`](precision.md) [`maxDec()`](precision.md)
  [`prec()`](precision.md) [`frac()`](precision.md) : Precision, Decimal
  Places and Fractional Part of a Numeric Value
